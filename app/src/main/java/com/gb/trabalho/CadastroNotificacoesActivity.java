...
public class CadastroNotificacoesActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.cadastro_notificacoes);
        ...
        if (intent != null) {
            ...
            String data = intent.getStringExtra("prazo");
            ...
            EditText edtData = findViewById(R.id.txt_prazo);
