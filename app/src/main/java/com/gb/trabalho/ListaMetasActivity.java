...
public class ListaMetasActivity extends AppCompatActivity {
        ...
        cadastroMetaLauncher = registerForActivityResult(
                ...
                result -> {
                    if (result.getResultCode() == RESULT_OK && result.getData() != null) {
                        ...
                        adicionarCard(descricao, valor, dataMeta, isReceita);
                    }
                }
        );
    ...
    private void adicionarCard(String descricao, String valor, String data, boolean isReceita) {
        ...
        card.setOnClickListener(v -> {
            ...
            Log.d("ListaMetas", "Abrindo meta: " + descricao + ", " + valor + ", " + data);
